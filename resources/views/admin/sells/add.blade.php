                                        ...
                                        <tbody>
                                            @foreach($products as $product)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><input v-model.lazy="quantity[{{$product->id}}]" name="quantity[{{$product->id}}]" value="0" type="number" class="form-control" max="{{ $product->stock }}" min="0" value="0" v-on:change="totalprod({{$product->id}}, {{$product->price}})"></td>
